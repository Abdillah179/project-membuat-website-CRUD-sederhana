                                ...
                                <div class="card-body">
                                    <form action="" method="post">
                                        ...
                                        <div class="form-group mb-5">
                                            ...
                                            <input type="text" class="form-control" name="tempat_lahir" id="tempat_lahir" placeholder="Masukkan Tempat Lahir Dosen" value="<?= $dosen["tempat_lahir"];?>">
                                        </div>
                                        <div class="form-group mb-5">
                                            <small class="form-text text-danger"><?= form_error("tanggal_lahir");?></small>
                                            <label for="tanggal_lahir" class="form-label">TANGGAL LAHIR</label>
                                            <input type="text" class="form-control" name="tanggal_lahir" id="tanggal_lahir" placeholder="Masukkan Tanggal Lahir Dosen" value="<?= $dosen["tanggal_lahir"];?>">
                                        </div>
                                        <div class="form-group mb-5">
                                            ...
                                            <input type="text" class="form-control" name="alamat_dosen" id="alamat_dosen" placeholder="Masukkan Alamat Dosen" value="<?= $dosen["alamat_dosen"]; ?>">
                                        </div>
                                        <div class="form-group mb-5">
                                            <small class="form-text text-danger"><?= form_error("nip_dosen");?></small>
                                            <label for="nip_dosen" class="form-label">NIP DOSEN</label>
                                            <input type="text" class="form-control" name="nip_dosen" id="nip_dosen" placeholder="Masukkan NIP Dosen" value="<?= $dosen["nip_dosen"]; ?>">
                                        </div>
                                        <div class="form-group mb-5">
                                            ...
                                            <label for="mengajar" class="col-form-label" style="font-size: 15px;">MENGAJAR : </label>
                                                <div class="col-8">
                                                    <select name="mengajar" id="mengajar" value="<?= $dosen["mengajar"];?>" class="form-select">
