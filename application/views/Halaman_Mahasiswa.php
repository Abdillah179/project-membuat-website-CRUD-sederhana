        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <form action="<?= base_url()?>Halaman_Mahasiswa/index" method="post"
                    ...
                    <table class="table">
                        ...
                        <?php foreach($mahasiswa as $mhs):?>
                            ...
                            <td class="d-flex justify-content-center">
                                <a href="<?= base_url()?>Halaman_Mahasiswa/HapusData/<?= $mhs["id"];?>" onclick="return confirm('Yakin')" class="badge badge-danger">Hapus</a>
                                <a href="<?= base_url()?>Halaman_Mahasiswa/Detail/<?= $mhs["id"];?>" class="badge badge-orange">Detail</a>
                                <a href="<?= base_url()?>Halaman_Edit_Mahasiswa/Ubah/<?= $mhs["id"];?>" class="badge badge-primary">Edit</a>
                            </td>
                            </tr>
                        </tbody>
                        <?php $i++;?>
